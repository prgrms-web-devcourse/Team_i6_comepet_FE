...
const LikeAreaPage = () => {
  ...
  const getSelectedTown = (selectedTown) => {
    let nextState = null;

    if (initialInterestAreas.length === 0) {
      nextState = [selectedTown];
      setInitialInterestAreas(nextState);
      return;
    }
    if (initialInterestAreas.length === 1) {
      ...
      nextState = [...initialInterestAreas, selectedTown];
      setInitialInterestAreas(nextState);
    }
    ...
    //   if (initialInterestAreas.length === 0) {
    //     return [selectedTown];
    //   } else if (initialInterestAreas.length === 1) {
